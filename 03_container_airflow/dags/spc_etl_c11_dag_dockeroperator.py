...
with DAG(
    dag_id='etl_spc_c11_data_etl_main',
    ...
    run_etl_script = DockerOperator(
        task_id='execute_etl_spc_c11_data_etl_main',
        ...
        command='bash -c "cd /app/projects/01_project_spc/01_etl_main/02_etl_scaled/ && python spc_etl_main_scale_task.py"',
