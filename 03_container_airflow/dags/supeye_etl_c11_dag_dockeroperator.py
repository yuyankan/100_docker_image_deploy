...
HOST_PROJECTS_PATH = '/home/carenk/my_data/01_projects/05_supeye/01_etl'
DOCKER_NETWORK = 'network_docker_common_nginxuse'
with DAG(
    dag_id='etl_supeye',
    ...
    run_etl_script = DockerOperator(
        task_id='execute_etl_supeye_c11_data_etl_main',
        ...
        # keep that tag.
        image='python_env_snap:202511', # Assuming you built the new image with Playwright
        # Command to run inside the newly spawned container
        command='bash -c "cd /app/projects/&& python supeye_main_etl.py"',
