...
with DAG(
    ...
    run_etl_script = DockerOperator(
        ...
        command='bash -c "cd /app/projects/01_project_spc/01_etl_main/02_etl_scaled && python spc_etl_outlier_check_v2_only.py"',
